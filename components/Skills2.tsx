        ...
        <div className="w-full md:w-3/4 p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="shadow rounded-md py-6 px-8 flex flex-col justify-start space-y-6 h-full bg-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div className="flex items-center">
                    ...
                    <h3 className="pl-2 text-lg font-semibold mb-2 text-gray-700    leading-5">Frontend development</h3>
                </div>
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                    <span className="text-3xl text-black    mr-1"><a href='https://nextjs.org' target='_blank'><SiNextdotjs /></a></span>
            ...
            <div className="shadow rounded-md py-6 px-8 flex flex-col justify-start space-y-6 h-full bg-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div className="flex items-center">
                    ...
                    <h3 className="pl-2 text-lg font-semibold mb-2 text-gray-700    leading-5">Backend development</h3>
                </div>
                <div className="text-md leading-tight">
                ...
                <div v-if="tools" className="flex flex-wrap gap-2 justify-center">
                    <span className="text-3xl text-black    mr-1"><a href='https://expressjs.com' target='_blank'><SiExpress /></a></span>
            ...
            <div className="shadow rounded-md py-6 px-8 flex flex-col space-y-6 h-full bg-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <Image src={datascience} alt='frontend image>' width={50} height={50}/>
                    <h3 className="pl-2 text-lg font-semibold mb-2 text-gray-700    leading-5">Data Science</h3>
                </div>
                <div className="text-md leading-tight">
                ...
                <div v-if="tools" className="flex flex-wrap gap-2 justify-center">
                    <span className="text-3xl text-black    mr-1"><a href='https://www.python.org' target='_blank'><FaPython /></a></span>
                    <span className="text-3xl text-black    mr-1"><a href='https://pandas.pydata.org/' target='_blank'><SiPandas /></a></span>
                    <span className="text-3xl text-orange-500 mr-1"><a href='https://www.tensorflow.org/' target='_blank'><SiTensorflow /></a></span>
                    <span className="text-3xl text-black    mr-1"><a href='https://numpy.org/' target='_blank'><SiNumpy /></a></span>                    
                </div>
            </div>          
            <div className="shadow rounded-md py-6 px-8 flex flex-col space-y-6 h-full bg-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div className="flex items-center">
                <Image src={mobiledev} alt='frontend image>' width={50} height={50}/>
                    <h3 className="pl-2 text-lg font-semibold mb-2 text-gray-700    leading-5">Mobile App Development</h3>
                </div>
                <div className="text-md leading-tight">
                ...
                <div v-if="tools" className="flex flex-wrap gap-2 justify-center">
                    ...
                    <span className="text-3xl text-black    mr-1"><a href='https://dart.dev' target='_blank'><SiDart /></a></span>                   
                </div>
            </div>                                                       
        </div>     
        </div>   
