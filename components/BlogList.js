...
export const BlogCard = ({difficulty, title, description, platform, date, image, bloglink, tagColor}) => (
  <div className="my-5">
  <a href={bloglink} target="_blank">
    <div className="rounded overflow-hidden bg-black duration-200 rounded-b md:rounded-b-none md:rounded-r pr-4 py-4 flex flex-col justify-between leading-normal">
      <div className="mb-8">
      <div className={'inline-block items-center ' + tagColor + ' rounded-lg px-2 mr-2 mb-2'}><p className="text-xs text-gray-700 font-medium flex items-center">{difficulty}</p></div>
