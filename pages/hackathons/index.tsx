        ...
        <main className="px-6 sm:px-6 md:px-12 py-5 sm:py-6 md:py-0 max-w-3xl mx-auto w-screen">
            ...
            <ol className="relative border-l border-gray-200">                  
                ...
                <li className="mb-10 ml-4">
                    ...
                    <p className="mb-4 text-base font-normal text-gray-100">How might we directly contribute towards environmental conservation or any of the Sustainable Development Goals 2030 through the digital payments space?</p>
                ...
                <li className="ml-4">
                    ...
                    <p className="mb-4 text-base font-normal text-gray-100 ">How might we help the young adults in developing financial literacy to grow their wealth at an early age?</p>
